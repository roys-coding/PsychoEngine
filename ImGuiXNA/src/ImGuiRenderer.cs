...
public sealed class ImGuiRenderer
{
    ...
    private          bool   _imguiStartedTextInput = false;
    ...
    private void SetupBackend()
    {
        ...
        // io.BackendPlatformName =  "imgui_impl_fna";
    ...
    public void NewFrame(GameTime gameTime)
    {
        ...
        // If ImGui wants text input.
        if (io.WantTextInput)
        {
            if (TextInputEXT.IsTextInputActive() && !_imguiStartedTextInput)
            {
                // Text input is already active.
                // Let ImGui know FNA is using text input.
                _imguiStartedTextInput = false;
            }
            else
            {
                // Text input is not active, activate it ourselves.
                // Let ImGui know we are using text input.
                TextInputEXT.StartTextInput();
                _imguiStartedTextInput = true;
            }
        }
        else
        {
            if (_imguiStartedTextInput)
            {
                // Stop text input if ImGui initialized it.
